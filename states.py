...
class State(TypedDict): # saari cheeje jo memory me hogi !! 
    topic : str
    summary : str 
    score : int 
...
# basemodel is the main class that is used to create models in pydantic.
...
# dataclass is a decorator that is used to create classes that are used to store data. 
# It automatically generates special methods like __init__(), __repr__(), __eq__(), etc. for the class.
